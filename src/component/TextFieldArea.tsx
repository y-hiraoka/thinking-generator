...
export const TextFieldArea = () => {
	...
	const {
		...
		tweet, handleTweetChange,
		reflectGlobalName, reflectGlobalTweet
...
const useTextFieldAreaState = () => {
	...
	const reflectGlobalName = (container: GlobalStateContainer) =>
	...
	const reflectGlobalTweet = (container: GlobalStateContainer) =>
		async (event: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
